...
import arduino_icon from "../../../assets/images/logos/frameworkIcons/arduino_icon.png";
...
export default function ClusterFrameworks({ darkMode }) {
  const data = [
    ...
    {
      icon: arduino_icon,
      icon_alt_text: "arduino_icon",
      title: "Arduino Framework",
      subtitle: "Library",
      text: "Uma biblioteca que abstrai programação embarcada em C/C++",
    },
    {
      icon: mui_icon,
