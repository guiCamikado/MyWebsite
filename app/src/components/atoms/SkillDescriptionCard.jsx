...
export default function SkillDescriptionCard({ darkMode, itensData }) {
    ...
    return (
        <div className="w-full h-full flex justify-center pt-4 px-10s">
            <div className=" text-[#FFE3C8] bg-[#201F20] border-2 border-[#201F20] hover:border-[#DD01E6] w-full max-w-md min-w-[33%] min-h-[20%] rounded-xl p-2 origin-top-left hover:rotate-1 hover:scale-105 transition-transform duration-600 ease-in-out">
